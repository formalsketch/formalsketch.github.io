...
A browser-based, dependency-free FSM designer. Draw states and transitions on a canvas, save them locally, export to PNG, SVG, or LaTeX. Originally written by [Evan Wallace](http://madebyevan.com/) in 2010; this fork modernizes the tooling, adds light/dark themes, undo/redo, and multi-FSM workspaces.
...
Based on the Finite State Machine Designer by **Evan Wallace** (2010), released under the MIT License. The modular structure (history / theme / workspace / I/O / UI) is adapted from the open pull request [evanw/fsm#45](https://github.com/evanw/fsm/pull/45). See [LICENSE](LICENSE) for the combined notice.
